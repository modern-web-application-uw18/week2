...
const MissedCard = ({ article: {title, link, image, description, author, postedDate, minutesToRead, hasAudioAvailable, memberPreview} }) =>
(
  <div className='cardMiss'>
    <img className="MCard-img" alt="stuff" src={image} />
